...
<html lang="en">
  <head>
    ...
    <!-- bootstrap theme -->
    <link href="{{ asset('theme/css/bootstrap-theme.css') }}" rel="stylesheet">
    <!--external css-->
    <!-- font icon -->
    <link href="{{ asset('theme/css/elegant-icons-style.css') }}" rel="stylesheet" />
    ...
    <link href="{{ asset('theme/assets/fullcalendar/fullcalendar/fullcalendar.css') }}" rel="stylesheet" />
    <!-- easy pie chart-->
    ...
    <link href="{{ asset('theme/css/jquery-jvectormap-1.2.2.css') }}" rel="stylesheet">
    <!-- Custom styles -->
    <link rel="stylesheet" href="theme/css/fullcalendar.css') }}">
    <link href="{{ asset('theme/css/widgets.css') }}" rel="stylesheet">
...
<header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="/home" class="logo">CV <span class="lite">thèque</span></a>
            <!--logo end-->
  ...
  <!-- container section start -->
    ...
    <script src="{{ asset('theme/js/jquery-ui-1.10.4.min.js') }}"></script>
    <script src="{{ asset('theme/js/jquery-1.8.3.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('theme/js/jquery-ui-1.9.2.custom.min.js') }}"></script>
    <!-- bootstrap -->
    ...
    <!-- charts scripts -->
    <script src="{{ asset('theme/assets/jquery-knob/js/jquery.knob.js') }}"></script>
    ...
    <<script src="{{ asset('theme/js/fullcalendar.min.js') }}"></script> <!-- Full Google Calendar - Calendar -->
    <script src="{{ asset('theme/assets/fullcalendar/fullcalendar/fullcalendar.js') }}"></script>
    <!--script for this page only-->
    <script src="{{ asset('theme/js/calendar-custom.js') }}"></script>
    <script src="{{ asset('theme/js/jquery.rateit.min.js') }}"></script>
    <!-- custom select -->
    <script src="{{ asset('theme/js/jquery.customSelect.min.js') }}" ></script>
    <script src="{{ asset('theme/assets/chart-master/Chart.js') }}"></script>
    ...
    <script src="{{ asset('theme/js/jquery-jvectormap-1.2.2.min.js') }}"></script>
    <script src="{{ asset('theme/js/jquery-jvectormap-world-mill-en.js') }}"></script>
    <script src="{{ asset('theme/js/xcharts.min.js') }}"></script>
    <script src="{{ asset('theme/js/jquery.autosize.min.js') }}"></script>
    <script src="{{ asset('theme/js/jquery.placeholder.min.js') }}"></script>
    <script src="{{ asset('theme/js/gdp-data.js') }}"></script>  
    <script src="{{ asset('theme/js/morris.min.js') }}"></script>
